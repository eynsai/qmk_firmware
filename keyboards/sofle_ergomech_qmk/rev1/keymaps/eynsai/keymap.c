...
[LAYER_BASE_WORKMAN] = LAYOUT(
    ...
    KC_LSFT,        KC_Z,           KC_X,           KC_M,           KC_C,           KC_V,                                           KC_K,           KC_L,           KC_COMM,        KC_DOT,         KC_SLSH,        KC_RSFT,
                    KC_NO,          KC_DOWN,        KC_UP,          SK_ALT,         KC_SPC,         SK_CTRL,        SK_BASE,        SK_SYMB,        SK_GUI,         KC_LEFT,        KC_RIGHT,
...
[LAYER_BASE_GAMING] = LAYOUT(
    ...
    KC_BSPC,        KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_QUOT,
    KC_LSFT,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMM,        KC_DOT,         KC_SLSH,        KC_RSFT,
                    KC_NO,          KC_TRNS,        KC_TRNS,        KC_LALT,        KC_TRNS,        KC_LCTL,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
                                                                                                                    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO
),
...
[LAYER_ARROWS] = LAYOUT(
    KC_NO,          KC_NO,          KC_LALT,        KC_LCTL,        KC_LSFT,        KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,
    KC_NO,          KC_NO,          CK_HALT,        CK_HCTL,        CK_HSFT,        KC_NO,                                          KC_NO,          KC_HOME,        KC_UP,          KC_END,         KC_NO,          KC_NO,
    KC_NO,          KC_NO,          CK_SALT,        CK_SCTL,        CK_SSFT,        KC_NO,                                          KC_NO,          KC_LEFT,        KC_DOWN,        KC_RGHT,        KC_NO,          KC_NO,
    KC_LSFT,        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          CK_DWL,         CK_DLN,         CK_DWR,         KC_NO,          KC_RSFT,
                    KC_NO,          KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
                                                                                                                    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO
),
